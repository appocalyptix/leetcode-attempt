...
public class ReorderLogFiles {
    ...
    private static class LogComparator implements Comparator<String> {
        ...
        public int compare(String s, String t) {
            ...
            String log1 = s.substring(s.lastIndexOf(' ')).trim();
            String log2 = t.substring(t.lastIndexOf(' ')).trim();

            boolean isLetterLog1 = log1.matches("[a-z]+");
            boolean isLetterLog2 = log2.matches("[a-z]+");
            ...
            if (isLetterLog1 && isLetterLog2) {
                res = s.substring(s.indexOf(' ') + 1).compareTo(t.substring(t.indexOf(' ') + 1));
                if (res == 0) {
    ...
    public static void main(String[] args) {
        String[] ss = {"wpylev6cnqv8 447241070789889321113517804297550370",
        ...
        String[] ll = rl.reorderLogFiles(ss);
